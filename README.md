This is a personal website with [Next.js](https://nextjs.org) bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
